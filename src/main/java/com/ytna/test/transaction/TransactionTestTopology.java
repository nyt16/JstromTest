package com.ytna.test.transaction;
...
import com.ytna.test.JStormHelper;
...
public class TransactionTestTopology {
    ...
    public static void test(String[] args) throws Exception {
        ...
        int split_Parallelism_hint = JStormUtils.parseInt(conf.get(SPLIT_PARALLELISM_HINT), 1);
        int count_Parallelism_hint = JStormUtils.parseInt(conf.get(COUNT_PARALLELISM_HINT), 1);
        ...
        if (args != null && args.length > 0) {
            ...
            cluster.submitTopology("word-count-transaction", conf, builder.createTopology());
